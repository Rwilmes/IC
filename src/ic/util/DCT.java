...
/**
 * NOTE: This class is part of a DCT library written by Steve Manley. 
 * 
 * All credits go to the author.
 * 
 * Source: http://www.nyx.net/~smanley/dct/DCT.html
 */

/**
 * <h3><b>DCT - A Java implementation of the Discreet Cosine Transform</b></h3><br>
 * <br>
 * <hr>
 ...
 * the image.<br>
 * <br>
 * The DCT is used in many compression and transmission codecs, such as JPEG,
 * MPEG and others. The pixels when transformed are arraged from the most
 * signifigant pixel to the least signifigant pixel. The DCT functions
 * themselves are lossless. Pixel loss occurs when the least signifigant pixels
 * are quantitized to 0. <br>
 * <br>
 * This is NOT a JPEG or JFIF compliant implementation however it could be with
 * very little extra work. (i.e. A huffman encoding stage needs to be added.) I
 * am making this source availible in the hopes that someone will add this
 * functionality to the class, if you do, please email me! As always, if you
 * have any problems feel free to contact me. (Or comments, or praise, etc..) <br>
 * <br>
 * <b>Keep in mind</b> that when compressing color images with this, you will
 * need to break the image up into it's R G B components and preform the
 * calculations three times!! <br>
 * <br>
 * <b>A general algorithim for DCT compression with this class:</b> <br>
 * <br>
 ...
 * 5) If you want, send the information to the imageCompressor().<br>
 * <br>
 * <b>A general algorithim for DCT decompression with this class:</b> <br>
 * <br>
 * 1) Create a DCT Object. <br>
 ...
 * <br>
 * <br>
 * A complete implementation of an image compressor which compares the quality
 * of the two images is also availible. See the JEncode/Decode <a
 * href="JEncode.java">source code.</a> The <a href="DCT.java">DCT.java source
 * code</a> is also availible. The implementation is also handy for seeing how
 * to break the image down, read in 8x8 blocks, and reconstruct it. The <a
 * href="steve.jpg"> sample graphic</a> is handy to have too. (Bad pic of me)
 * The best way to get ahold of me is through my <a
 * href="http://eagle.uccb.ns.ca/steve/home.html">homepage</a>. There's lots of
 * goodies there too.
 * 
 * @version 1.0.1 August 22nd 1996
 * @author <a href="http://eagle.uccb.ns.ca/steve/home.html">Stephen Manley</a>
...
public class DCT {
	 ...
	 * 
	 * @param QUALITY
	 *            The quality of the image (0 best - 25 worst)
	 * 
	 */
	 ...
	 * 
	 * @param inputData
	 *            8x8 Array of quantitized image data
	 * @param zigzag
	 *            Boolean switch to enable/disable zigzag path.
	 ...
	 * Huffman, Adaptive Huffman or arithmetic encoding will give much better
	 * preformance. The information accepted is quantitized DCT data. The output
	 * array should be scanned to determine where the end is.
	 * 
	 * @param image
	 *            Quantitized image data.
	...
	/**
	 * This method determines the runs in the input data, decodes it and then
	 * returnss the corrected matrix. It is used to decode the data from the
	 * compressImage method. Huffman encoding, Adaptive Huffman or Arithmetic
	 * will give much better compression.
	 * 
	 * @param DCT
	 *            Compressed DCT int array (Expands to whole image).
	...
	/**
	 * This method uses bit shifting to convert an array of two bytes to a
	 * integer (16 bits max). Byte 0 is the most signifigant byte and Byte 1 is
	 * the least signifigant byte.
	 * 
	 * @param bitSet
	 *            Two bytes to convert
	...
	/**
	 * This method uses bit shifting to convert an integer to an array of two
	 * bytes, byte 0, the most signifigant and byte 1, the least signifigant.
	 * 
	 * @param count
	 *            The integer to convert. (16 bit max)
